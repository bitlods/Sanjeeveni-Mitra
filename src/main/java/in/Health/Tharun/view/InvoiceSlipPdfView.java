...
public class InvoiceSlipPdfView extends AbstractPdfView {
	...
	protected void buildPdfDocument(
		...
		Paragraph address = new Paragraph("Bangalore, Karnataka, 500032",addrFont);
		...
		//Image img = Image.getInstance("https://www.sookshmas.com/ImgsU/m/113/060122054702113.jpg");
